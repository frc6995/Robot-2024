...
public class TunerConstants {
    ...
    private static final double kWheelRadiusInches = 3.95/2.0;

    public static final double kSpeedAt12VoltsRps = 
         // motor rev / wheel rev
        kDriveGearRatio *
        kSpeedAt12VoltsMps / //meter/s
       ( 2 * Math.PI * kWheelRadiusInches * 0.0254); //wheelrev/meter
...
//         .withKS(0.1).withKV(12.0/kSpeedAt12VoltsRps).withKA(0.05);
    ...
    private static final double kSteerInertia = 0.0001;
    ...
    private static final double kFrontLeftEncoderOffset = 0.439435125;
    ...
    private static final double kFrontRightEncoderOffset = -0.330566;
    ...
    private static final double kBackLeftEncoderOffset = -0.1520996;
    ...
    private static final double kBackRightEncoderOffset = 0.12670;
    ...
    public static final Swerve DriveTrain = new Swerve(DrivetrainConstants, Utils.isSimulation()?50:250, FrontLeft,
