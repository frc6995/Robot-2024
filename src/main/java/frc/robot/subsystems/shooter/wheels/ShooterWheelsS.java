...
public class ShooterWheelsS implements Logged {
  ...
  public ShooterWheelsS() {
    m_topRoller = new ShooterRoller(Constants.TOP_CAN_ID,  true, 0.05, 12/(9000.0 / 60.0), 0.05, 1/100.0, "Top");// kA 0.016432/60.0
    topSysId = m_topRoller.m_idRoutine;
    m_bottomRoller = new ShooterRoller(Constants.BOTTOM_CAN_ID, true, 0, 12/(9000.0 / 60.0), 0.05, 1/100.0, "Bottom"); //kA 0.017026/60.0
