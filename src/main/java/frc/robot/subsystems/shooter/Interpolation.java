...
public class Interpolation {
    ...
    static {
        ...
        entry(2.75, 2.51+Units.degreesToRadians(1), 7000, 7000-1000);
        entry(2.85, 2.55+Units.degreesToRadians(1),7000, 7000-1500 );
        ...
        // passing shot
        entry(PASSING_DISTANCE+0.01, Units.degreesToRadians(180 - 45), 3000, 2700);
        entry(9, Units.degreesToRadians(180 - 45), 6000, 5400);
