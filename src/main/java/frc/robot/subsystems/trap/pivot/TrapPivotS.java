 ...
 * 
 */
public class TrapPivotS extends SubsystemBase implements Logged {
  /**
   * IO class for interacting with motor.
   */
  private TrapPivotIO m_io;
  /**
  ...
  public TrapPivotS() {
    ...
    if (Robot.isSimulation()) {
      m_io = new SimTrapPivotIO();
    }
    else {
      m_io = new RealTrapPivotIO();
    }
  ...
  public void periodic() {
    ...
    TRAP_PIVOT.setAngle(Units.radiansToDegrees(m_io.getAngle()));
  ...
  public class Constants {
    ...
    public static final double K_V =  
      MOTOR_ROTATIONS_PER_ARM_ROTATION/(DCMotor.getNeoVortex(1).KvRadPerSecPerVolt); 
