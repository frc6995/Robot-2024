...
import static frc.robot.subsystems.bounceBar.BounceBarS.Constants.*;
import static frc.robot.subsystems.bounceBar.BounceBarS.Constants.*;
...
public class RealBounceBarIO extends BounceBarIO {
    ...
    public RealBounceBarIO() {
        super();
        m_motor = new SparkBaseConfig(Constants.config).applyMax(

            SparkDevice.getSparkMax(BounceBarS.Constants.CAN_ID)
            , true);
        // m_motor = SparkDevice.getSparkMax(BounceBarS.Constants.CAN_ID);
